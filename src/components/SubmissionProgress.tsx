...
export const SubmissionProgress: React.FC<SubmissionProgressProps> = ({
  ...
  const sortedDimensions = [...dimensions].sort((a, b) => a.dimension_id - b.dimension_id);
    ...
    <>
          ...
          {sortedDimensions.map(dimension => {
            ...
            return (
              <button
                ...
                onClick={() => !hasJeu && setSelectedDimension(dimension)}
                disabled={hasJeu}
                className={`
                  ...
                  <div className="text-sm text-gray-500">
                    {hasJeu ? (
                      ...
                      <span className="text-green-600">
                        Completed by {getTeamName(submission.team_id)}
                        <br />
                        <span className="text-gray-400 text-xs">
      ...
      {selectedDimension && (
        <DimensionModal
          ...
          isSubmitted={!!submissionMap[selectedDimension.dimension_id]}
        />
      )}
    </>
  );
